##!/usr/bin/env bash
#
# Pull the Controls/Countermeasures for a project
#
# Script use
#
...
api_url="${instance_url}/api/v1/products/${referenceid}/controls";
